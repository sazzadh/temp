            ...
            <ul class="account-menu">
                ...
                <?php if ( $cs_education_switch == 'on' || $cs_experience_switch == 'on' || $cs_portfolio_switch == 'on' || $cs_skills_switch == 'on' || $cs_award_switch == 'on' ) { ?>
                    <li id="candidate_left_resume_link" <?php if ( isset($_REQUEST['profile_tab']) && $_REQUEST['profile_tab'] == 'resume' ) echo 'class="active"'; ?>>
                        <a id="candidate_resume_click_link_id"  href="javascript:void(0);" onclick="cs_dashboard_tab_load('resume', 'candidate', '<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo absint($uid); ?>');" ><i class="icon-newspaper4"></i><?php esc_html_e('My Resume', 'jobhunt'); ?></a>	
                ...
                <?php if ( ! $plugon_active ) { ?>
                    <li id="candidate_left_cv_link" <?php if ( isset($_REQUEST['profile_tab']) && $_REQUEST['profile_tab'] == 'cv' ) echo 'class="active"'; ?>>
                        <a id="candidate_cv_click_link_id"  href="javascript:void(0);" onclick="cs_dashboard_tab_load('cv', 'candidate', '<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo absint($uid); ?>');" ><i class="icon-vcard"></i><?php echo esc_html__('CV &amp; Cover Letter', 'jobhunt'); ?></a>
                    </li>
                <?php } ?>
                <li id="candidate_left_change_password_link" <?php if ( isset($_REQUEST['profile_tab']) && $_REQUEST['profile_tab'] == 'change_password' ) echo 'class="active"'; ?>>
                    <a id="candidate_change_password_click_link_id"  href="javascript:void(0);" onclick="cs_dashboard_tab_load('change_password', 'candidate', '<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo absint($uid); ?>');" ><i class="icon-key4"></i><?php esc_html_e('Change Password', 'jobhunt'); ?></a>
                </li>
                <li id="candidate_left_membership_packages_link" <?php if ( isset($_REQUEST['profile_tab']) && $_REQUEST['profile_tab'] == 'packages' ) echo 'class="active"'; ?>>
                    <a id="candidate_membership_packages_click_link_id"  href="javascript:void(0);" onclick="cs_dashboard_tab_load('packages', 'candidate', '<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo absint($uid); ?>');" ><i class="icon-vcard"></i> <?php esc_html_e('Packages', 'jobhunt'); ?></a>	
                </li>
                            ...
                            if ( $cs_page_id != '' && $cs_user_role_type != '' ) {
                                if ( $cs_user_role_type == 'candidate' ) {
                                    ...
                                    <ul class="dropdown-menu <?php echo esc_html($menu_cls); ?>">
                                        ...
                                        <?php } ?>
                                        <li>
                                            <a href="<?php echo esc_url(cs_users_profile_link($cs_page_id, 'resume', $uid)); ?>" <?php echo force_balance_tags($data_toogle); ?>><i class="icon-newspaper4"></i> <?php esc_html_e('My Resume', 'jobhunt'); ?></a>	
                                        </li>
                                        <?php
                                        $display_shortlist_button = 'yes';
                                        $display_shortlist_button = apply_filters('jobhunt_candidate_lists_shortlist_button', $display_shortlist_button);
                                        ...
                                        <?php if ( ! $plugon_active ) { ?>
                                            <li>
                                                <a href="<?php echo esc_url(cs_users_profile_link($cs_page_id, 'cv', $uid)); ?>" <?php echo force_balance_tags($data_toogle); ?>><i class="icon-vcard"></i> <?php esc_html_e('CV & cover letter', 'jobhunt'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if ( ! $plugon_active ) { ?>
                                            <li>
                                                <a href="<?php echo esc_url(cs_users_profile_link($cs_page_id, 'packages', $uid)); ?>" <?php echo force_balance_tags($data_toogle); ?>><i class="icon-vcard"></i> <?php esc_html_e('Packages', 'jobhunt'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <li>
                                            <a href="<?php echo esc_url(cs_users_profile_link($cs_page_id, 'change_password', $uid)); ?>" <?php echo force_balance_tags($data_toogle); ?>><i class="icon-key4"></i> <?php esc_html_e('Change Password', 'jobhunt'); ?></a>
                                        </li>
                                    ...
                                    <ul class="dropdown-menu <?php echo esc_html($menu_cls); ?>">
                                        ...
                                        <li>
                                            <a href="<?php echo esc_url(cs_users_profile_link($cs_page_id, 'profile', $uid)); ?>" <?php echo force_balance_tags($data_toogle); ?>><i class="icon-newspaper4"></i> <?php esc_html_e('Company Profile', 'jobhunt'); ?></a>
                                        </li> 
                                        <li>
                                        ...
                                        <?php if ( $candidate_enable == true && $remove_candidate_role != 'yes' ) { ?>
                                            ...
                                            <?php if ( $cs_candidate_switch == 'on' ) { ?>
                                                <li>
                                                    <a href="<?php echo esc_url(cs_users_profile_link($cs_page_id, 'resumes', $uid)); ?>" <?php echo force_balance_tags($data_toogle); ?>><i class="icon-heart11"></i> <?php esc_html_e('Resumes', 'jobhunt'); ?></a>	
                                                </li>
                                            <?php } else { ?>
                                                <li>
                                                    <a href="<?php echo esc_url(cs_users_profile_link($cs_page_id, 'resumes', $uid)); ?>" <?php echo force_balance_tags($data_toogle); ?>><i class="icon-newspaper4"></i> <?php esc_html_e('Resumes', 'jobhunt'); ?></a>	
                                                </li>
                                            <?php } ?>
        ...
        $skills_array = array(
            ...
            'social_network' => array(
                ...
                'list' => array(
                    ...
                    'cs_google_plus' => array(
                        'name' => esc_html__('Google Plus', 'jobhunt'),
                    ),
                    'cs_linkedin' => array(

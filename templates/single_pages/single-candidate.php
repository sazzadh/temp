                ...
                if ( $cs_candidate_view == true ) {
                    ...
                    <div class="main-section">
                        <div class="page-section">
                            <div class="candidate-header<?php echo esc_html($cs_header_paralax_class) ?> <?php echo esc_html($cs_candidate_default_cover_style) ?>"<?php echo ($cs_header_style != '' ? ' style="' . $cs_header_style . '"' : '') ?>>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="cs-profile">
                                                ...
                                                <?php } ?>
                                                <div class="info">
                                                    <div class="title"><h3><?php echo $display_name; ?></h3></div>
                                                ...
                                                <div class="post-options">
                                                    <ul>
                                                        <li><i class="icon-clock-o"></i><?php esc_html_e('Member Since', 'jobhunt') ?>, <?php echo date_i18n(get_option('date_format'), strtotime($cs_user_data->user_registered)); ?></li>
                                                        <?php
                                                        $display_candidate_contact_details = 'yes';

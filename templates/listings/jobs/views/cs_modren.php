                    ...
                    <div class="jobs-content<?php echo $featured_class; ?>">
                        ...
                        <div class="cs-text">
                            ...
                            <ul>
                                ...
                                ?>
                                <?php if ( $cs_job_posted <> '' ) { ?><li><span> <?php esc_html_e('Posted', 'jobhunt'); ?></span> <?php echo cs_time_elapsed_string($cs_job_posted); ?></li><?php } ?>
                            ...
                            <p><?php echo wp_trim_words(get_the_content($cs_job_id), 20, '...'); ?></p>
                            <a class="read-more cs-color" href="<?php echo esc_url(get_permalink($cs_job_id)); ?>"><?php esc_html_e('Read more', 'jobhunt'); ?></a>

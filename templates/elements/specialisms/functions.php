...
if ( ! function_exists('cs_job_specialisms_shortcode') ) {
    ...
    function cs_job_specialisms_shortcode($atts, $content = "") {
        ...
        $btm_class = isset($specialisms_view) && ($specialisms_view == 'simple' || $specialisms_view == 'grid-fancy') ? ' simple' : '';
        $color_class = isset($specialisms_view) && ($specialisms_view == 'simple' || $specialisms_view == 'grid-fancy') ? '' : ' cs-color';
        ...
        $cs_html_count = '';
        if ( $job_specialisms_subtitle_switch == 'yes' && $specialisms_view != 'simple' && $specialisms_view != 'grid-fancy' ) {
        ...
        if ( isset($job_specialisms_title) && ! empty($job_specialisms_title) && ($specialisms_view == 'simple' || $specialisms_view == 'grid-fancy') ) {  // remove title div if empty
        ...
        if ( isset($specialisms_view) && ($specialisms_view == 'simple' || $specialisms_view == 'grid-fancy') ) {
            $cs_html .= $cs_li_html;
        }
        ...
        if ( $specialisms_view != 'simple' && $specialisms_view != 'grid-fancy' ) {
            $cs_html .= do_shortcode($content);
        }

        if ( $job_specialisms_view_all_link != '' ) {

 ...
 */
if ( ! class_exists('jobhunt_reset_password_email_template') ) {

    class jobhunt_reset_password_email_template {
        ...
        public function __construct() {
            ...
            add_action('jobhunt_reset_password_email', array( $this, 'reset_password_email_callback' ), 10, 2);
        ...
        public function reset_password_email_callback($arg) {
            ...
            if ( isset($template['email_notification']) && $template['email_notification'] == 1 ) {
                ...
                $subject = (isset($template['subject']) && $template['subject'] != '' ) ? $template['subject'] : esc_html__('Your new password', 'jobhunt');
                ...
                jobhunt_reset_password_email_template::$is_email_sent1 = $this->is_email_sent;
            }
        }
        ...
        public function add_email_template() {
            ...
            $email_templates[$this->template_group][$this->email_template_index] = array(
                ...
                'description' => __('This template is used sending email to user when reset password.', 'jobhunt'),
                'jh_email_type' => 'html',
            );
    ...
    new jobhunt_reset_password_email_template();
}
